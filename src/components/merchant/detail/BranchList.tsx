...
export default function BranchList({ merchantId }: { merchantId: number }) {
  ...
  const [params, setParams] = useState<BaseParams>(initialBaseParams);
        ...
        <div className="flex gap-3.5">
          <div className="hidden h-11 items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 lg:inline-flex dark:bg-gray-900">
            <button
              ...
              className={`text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white ${filterStatus === "All"
            ...
            <button
              ...
              className={`text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white ${filterStatus === "Active"
                ? "shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800"
                : "text-gray-500 dark:text-gray-400"
                }`}
            >
            ...
            <button
              ...
              className={`text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white ${filterStatus === "Inactive"
                ? "shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800"
                : "text-gray-500 dark:text-gray-400"
                }`}
            >
                  ...
                  <div className="flex items-center gap-3">
                    <label className="flex cursor-pointer items-center text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                      <span className="relative">
                        ...
                        />
                        <span
                          className={`flex h-4 w-4 items-center justify-center rounded-sm border-[1.25px] ${paginatedInvoices.length > 0 &&
                            paginatedInvoices.every((i) =>
                              selected.includes(i.id)
                            )
                  ...
                  <div className="relative flex justify-center dropdown">
                    <TableDropdown
                      ...
                      dropdownContent={
                        <>
                          <button
                            onClick={() => router.push(`/merchant/${encodeId(merchantId)}/branches/${encodeId(branch.id)}/edit`)}
            ...
            {visiblePages.map((page) => (
              <li key={page}>
                <button
                  ...
                  className={`flex h-10 w-10 items-center justify-center rounded-lg text-sm font-medium ${page === currentPage

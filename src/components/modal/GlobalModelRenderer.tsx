...
import { useGlobalModal, ModalType } from '@/context/ModalContext';
import { Modal } from '../ui/modal';
import Button from '../ui/button/Button';

const SuccessIcon = () => {
    return <div className="relative flex items-center justify-center z-1 mb-7">
        <svg
...
const MODAL_CONFIG: Record<ModalType, { title: string; color: string; icon: ReactNode; buttonText: string }> = {
    success: {
        title: 'Sucess',
...
export default function GlobalModalRenderer() {
    const { isOpen, closeModal, content, title, onConfirm, autoCloseDelay, type } = useGlobalModal();
    ...
    }, [isOpen, autoCloseDelay, closeModal, onConfirm]);
            ...
            <div className="text-center">
                ...
                </div> */}
                {
                    ...
                    <div className="flex items-center justify-center w-full gap-3 mt-8">
                        ...
                        <Button className="bg-warning-500 shadow-theme-xs hover:bg-warning-600" size="sm" onClick={() => {
                            closeModal();
                            onConfirm?.();
                        }}>
                            {config.buttonText}

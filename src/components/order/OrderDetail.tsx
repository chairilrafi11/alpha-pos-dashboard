...
import { OrderDetail } from "@/types/order/order";

interface OrderDetailProps {
  order_id: number;
}

export default function OrderDetailMain({ order_id }: OrderDetailProps) {
        ...
        <div className="flex flex-col gap-6 mb-9 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <span className="block text-sm text-gray-500 dark:text-gray-400">
              {dateFormatReadable(order?.transaction_date || "")}
            </span>
          </div>

"use client";
import { PaginatedResponse, initialPageInfo, BaseParams } from "@/types/shared/commonModel";
      ...
      <div className="flex flex-col gap-5 sm:flex-row  sm:items-center justify-between border-b border-gray-100 py-4 dark:border-gray-800">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Role data is used to access feature of Alpha POS
          </p>
        </div>
        <div>
          <AddRoleModal />
        ...
        <table className="min-w-full">
          <thead>
            <tr className="border-b border-gray-100 dark:border-gray-800">
              <th className="py-5 py-4 text-center text-xs font-medium text-gray-500 dark:text-gray-400">
                No
              </th>
            ...
            {roles.data.map((role, index) => (
              <tr key={role.id}>
                <td className="text-center px-5 py-3 whitespace-nowrap">
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    {getNoRow(index, roles.page_info.page_number, roles.page_info.page_size)}
                  </p>
                </td>
                ...
                <td className="px-5 py-3 whitespace-nowrap">
                  <span
                    className={`inline-flex items-center justify-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium ${true
                ...
                <td className="px-5 py-3 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                  {dateFormatReadable(role.created_at)}
                </td>
                <td className="px-5 py-3 whitespace-nowrap">
